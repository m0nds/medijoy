        ...
        <div className="text-center sm:p-6 lg:p-10">
          ...
          <div className="mt-10 sm:mt-16 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-3">
            <button
              ...
              className="w-full sm:w-auto rounded-2xl bg-[#6B8E23] px-8 py-3 sm:px-10 text-white hover:opacity-95 text-center text-sm sm:text-base"
            >
              Book a Consultation
            </button>
          <p className="block sm:hidden text-xs sm:text-sm max-w-3xl text-[#9d9595] mx-auto">£20 Redeemable consultation fee</p>
          ...
          <p className="mt-3 hidden sm:block sm:mt-4 text-xs sm:text-sm max-w-3xl text-[#9d9595] mx-auto">£20 Redeemable consultation fee</p>
        </div>
